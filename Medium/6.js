function findLostElements(arr1, arr2) {
  ...
  const lostElements = Object.keys(occurrences).filter((element) => occurrences[element] !== 0);

  return lostElements;
}
console.log(findLostElements([1, 2, 3, 4, 5, 6, 7, 8], [1, 3, 4, 5, 6, 7, 8]));
console.log(findLostElements([true,true,false,false,true],[true,false,false,true]));
console.log(
